 ...
 */
public class HMS_ChangePassword1_Rec extends javax.swing.JFrame {

    /**
     * Creates new form HMS_ChangePassword
     */
    public HMS_ChangePassword1_Rec() {
        initComponents();
    }
...
public String x;
        ...
        try {
            ...
            if(newpwrd1.equals(newpwrd2))
            {
                try {
                    ...
                    Logger.getLogger(HMS_ChangePassword1_Rec.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HMS_ChangePassword1_Rec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HMS_ChangePassword1_Rec().setVisible(true);
            }
        });
    }
