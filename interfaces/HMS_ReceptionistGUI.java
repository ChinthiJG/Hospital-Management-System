...
import Details.HMS_ReceptionistDetails;
import GetSet.HMS_Receptionist;
import Validations.Validations_Recep;
 ...
 */
public class HMS_ReceptionistGUI extends javax.swing.JFrame {

    /**
     * Creates new form PatientDetails
     */
    public HMS_ReceptionistGUI() {
        initComponents();
        AutoID();
        receptionist_table();
        HMS_ReceptionistDetails rd = new HMS_ReceptionistDetails();
        rd.setDisable(this);
       ...
       txtStartDate1.setMaxSelectableDate(new java.util.Date());
        txtStartDate1.setDateFormatString("dd-MM-yyyy");
     ...
     public void receptionist_table()
    {
        ...
        try {
            ...
            pst = dbConn.prepareStatement("select * from receptionist");
            rs = pst.executeQuery();
            ...
            DefaultTableModel df = (DefaultTableModel)tblreceptionist.getModel();
            df.setRowCount(0);
            ...
            while(rs.next())
            {
                ...
                for(int i=1;i<=c;i++)
                {
                    v2.add(rs.getString("receptionistno"));
            ...
            Logger.getLogger(HMS_ReceptionistGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
     ...
     public void AutoID()
    {
        ...
        try {
            ...
            rs = s.executeQuery("select MAX(receptionistno) from receptionist");
            rs.next();
            rs.getString("MAX(receptionistno)");
            
            if(rs.getString("MAX(receptionistno)")==null)
            {
                lblrecpno1.setText("RE001");
                
            }
            else
            {
                long id = Long.parseLong(rs.getString("MAX(receptionistno)").substring(2,rs.getString("MAX(receptionistno)").length()));
                id++;
                lblrecpno1.setText("RE"+String.format("%03d",id));
            }
    ...
    private void initComponents() {
        ...
        txtrecpno2 = new javax.swing.JTextField();
        ...
        txtExperience2 = new javax.swing.JTextField();
        ...
        txtrecpno3 = new javax.swing.JTextField();
        ...
        txtExperience3 = new javax.swing.JTextField();
        jLabel76 = new javax.swing.JLabel();
        txtStartDate3 = new javax.swing.JTextField();
        ...
        jPanel6.add(jLabel2);
        jLabel2.setBounds(120, 40, 380, 80);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/receptionist circle icon.png"))); // NOI18N
        jPanel6.add(jLabel3);
        jLabel3.setBounds(0, 20, 110, 110);

        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/home circle icon.png"))); // NOI18N
        ...
        jLabel13.setBounds(1280, 50, 60, 60);
        ...
        jLabel4.setText("ID");
        jPanel6.add(jLabel4);
        jLabel4.setBounds(80, 200, 180, 50);

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 153, 255));
        jLabel5.setText("Experience");
        jPanel6.add(jLabel5);
        jLabel5.setBounds(80, 600, 140, 50);
        ...
        txtSecond1.setBounds(860, 270, 370, 50);
        ...
        txtPhone1.setBounds(860, 480, 370, 40);
        ...
        comboGender1.setBounds(860, 340, 370, 40);
        ...
        jPanel6.add(btnAdd);
        btnAdd.setBounds(1060, 690, 280, 60);

        lblrecpno1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        lblrecpno1.setText("Receptionist Id");
        jPanel6.add(lblrecpno1);
        lblrecpno1.setBounds(250, 210, 360, 30);

        txtbirthdate1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel6.add(txtbirthdate1);
        txtbirthdate1.setBounds(860, 410, 370, 40);
        ...
        jLabel37.setBounds(80, 260, 120, 50);

        txtExperience1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel6.add(txtExperience1);
        txtExperience1.setBounds(250, 610, 370, 40);

        txtStartDate1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel6.add(txtStartDate1);
        txtStartDate1.setBounds(870, 610, 360, 40);
        ...
        jLabel77.setBounds(690, 610, 160, 40);
        ...
        lblLogout2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/logout icon circle.png"))); // NOI18N
        lblLogout2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblLogout2MouseClicked(evt);
            }
        });
        jPanel10.add(lblLogout2);
        lblLogout2.setBounds(1340, 50, 60, 60);
        ...
        jLabel52.setText("Update Receptionist");
        jPanel10.add(jLabel52);
        jLabel52.setBounds(120, 40, 420, 80);

        jLabel53.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/receptionist circle icon.png"))); // NOI18N
        ...
        jLabel55.setBounds(80, 330, 120, 50);
        ...
        jLabel58.setBounds(690, 330, 160, 50);

        txtrecpno2.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        txtrecpno2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtrecpno2ActionPerformed(evt);
            }
        });
        jPanel10.add(txtrecpno2);
        txtrecpno2.setBounds(240, 170, 370, 40);
        ...
        jLabel60.setBounds(80, 470, 160, 50);
        ...
        jLabel66.setBounds(80, 400, 120, 50);
        ...
        btnUpdate.setBounds(1060, 680, 280, 60);
        ...
        txtFirst2.setBounds(250, 270, 370, 50);
        ...
        txtSecond2.setBounds(860, 270, 370, 50);
        ...
        txtNic2.setBounds(250, 340, 370, 40);
        ...
        txtAge2.setBounds(250, 410, 370, 40);
        ...
        txtPhone2.setBounds(860, 480, 370, 40);
        ...
        jLabel38.setBounds(80, 600, 140, 50);

        txtExperience2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel10.add(txtExperience2);
        txtExperience2.setBounds(250, 610, 370, 40);
        ...
        jLabel75.setBounds(690, 610, 160, 40);

        txtStartDate2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txtStartDate2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtStartDate2ActionPerformed(evt);
            }
        });
        jPanel10.add(txtStartDate2);
        txtStartDate2.setBounds(860, 610, 370, 40);

        txtbirthdate2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel10.add(txtbirthdate2);
        txtbirthdate2.setBounds(860, 410, 370, 40);
        ...
        comboGender2.setBounds(860, 340, 370, 40);
        ...
        lblLogout3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/logout icon circle.png"))); // NOI18N
        lblLogout3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblLogout3MouseClicked(evt);
            }
        });
        jPanel7.add(lblLogout3);
        lblLogout3.setBounds(1340, 50, 60, 60);

        jLabel34.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/home circle icon.png"))); // NOI18N
        jPanel7.add(jLabel34);
        jLabel34.setBounds(1280, 50, 60, 60);
        ...
        jLabel17.setBounds(120, 40, 420, 80);

        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/receptionist circle icon.png"))); // NOI18N
        ...
        txtrecpno3.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        txtrecpno3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtrecpno3ActionPerformed(evt);
            }
        });
        jPanel7.add(txtrecpno3);
        txtrecpno3.setBounds(240, 170, 370, 40);
        ...
        jLabel32.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/logout icon circle.png"))); // NOI18N
        ...
        jLabel32.setBounds(1340, 50, 60, 60);
        ...
        txtFirst3.setBounds(250, 270, 370, 50);
        ...
        jPanel7.add(txtNic3);
        txtNic3.setBounds(250, 340, 370, 40);
        ...
        txtPhone3.setBounds(860, 480, 370, 40);
        ...
        txtGender3.setBounds(860, 340, 370, 40);
        ...
        txtSecond3.setBounds(860, 270, 370, 50);
        ...
        jLabel39.setBounds(80, 600, 140, 50);

        txtExperience3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jPanel7.add(txtExperience3);
        txtExperience3.setBounds(250, 610, 370, 40);

        jLabel76.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel76.setForeground(new java.awt.Color(0, 153, 255));
        jLabel76.setText("Start Date");
        jPanel7.add(jLabel76);
        jLabel76.setBounds(690, 610, 160, 40);

        txtStartDate3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txtStartDate3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtStartDate3ActionPerformed(evt);
            }
        });
        jPanel7.add(txtStartDate3);
        txtStartDate3.setBounds(860, 610, 370, 40);
        ...
        jTabbedPane1.addTab("Delete Receptionist", jPanel3);
        ...
        jLabel49.setText("View Receptionist");
        jPanel9.add(jLabel49);
        jLabel49.setBounds(120, 40, 380, 80);

        jLabel50.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hms/images/receptionist circle icon.png"))); // NOI18N
        ...
        tblreceptionist.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        tblreceptionist.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "First Name", "Second Name", "NIC", "Age", "Gender", "Address", "BirthDate", "Married Status", "Phone", "Experience", "Start Date"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class
            };
        ...
        if (tblreceptionist.getColumnModel().getColumnCount() > 0) {
            tblreceptionist.getColumnModel().getColumn(0).setResizable(false);
            tblreceptionist.getColumnModel().getColumn(1).setResizable(false);
            tblreceptionist.getColumnModel().getColumn(2).setResizable(false);
            tblreceptionist.getColumnModel().getColumn(3).setResizable(false);
            tblreceptionist.getColumnModel().getColumn(4).setResizable(false);
            tblreceptionist.getColumnModel().getColumn(5).setResizable(false);
            tblreceptionist.getColumnModel().getColumn(6).setResizable(false);
            tblreceptionist.getColumnModel().getColumn(7).setResizable(false);
            tblreceptionist.getColumnModel().getColumn(8).setResizable(false);
            tblreceptionist.getColumnModel().getColumn(9).setResizable(false);
        }
    ...
    private void btnSearch2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearch2ActionPerformed
        ...
        String id = txtrecpno3.getText();
        
        HMS_ReceptionistDetails recp = new HMS_ReceptionistDetails();
        HMS_Receptionist receptionist = recp.find(id);
        
         txtFirst3.setText(receptionist.getFirstname());
         txtSecond3.setText(receptionist.getSecondname());
         txtNic3.setText(receptionist.getNic());
         txtGender3.setText(receptionist.getGender());
         txtAge3.setText(receptionist.getAge());
         txtbirthdate3.setText(receptionist.getBirthday());
         txtMarried3.setText(receptionist.getMstatus());
         txtAddress3.setText(receptionist.getAddress());
         txtExperience3.setText(receptionist.getExperience());
         txtStartDate3.setText(receptionist.getStartDate());
         txtPhone3.setText(receptionist.getPhone());
        
    }//GEN-LAST:event_btnSearch2ActionPerformed

    private void txtrecpno3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtrecpno3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtrecpno3ActionPerformed

    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        
       
        
        String recpno = txtrecpno2.getText();
        ...
        String experience = txtExperience2.getText();
        String startdate = txtStartDate2.getText();
        String phone = txtPhone2.getText();
        
        
       HMS_Receptionist id = new HMS_Receptionist(experience,startdate,recpno,firstname, secondname, nic, gender,age,birthday,mstatus,phone,address);
       HMS_ReceptionistDetails pd = new HMS_ReceptionistDetails();
       pd.updateRecord(id);
    ...
    private void btnSearch1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearch1ActionPerformed
        ...
        String id = txtrecpno2.getText();
        
        HMS_ReceptionistDetails pd = new HMS_ReceptionistDetails();
        HMS_Receptionist receptionist = pd.find(id);
        
        txtFirst2.setText(receptionist.getFirstname());
        txtSecond2.setText(receptionist.getSecondname());
        txtNic2.setText(receptionist.getNic());
        
        txtAge2.setText(receptionist.getAge());
        String bdate = receptionist.getBirthday();
        ...
        txtbirthdate2.setDate(date);
         ...
         if (receptionist.getGender().equals("Male")) {
          ...
          if (receptionist.getMstatus().equals("Single")) {
           comboReleationship2.setSelectedIndex(0);
        } else {
            comboReleationship2.setSelectedIndex(1);
        }
        
        txtAddress2.setText(receptionist.getAddress());
        txtExperience2.setText(receptionist.getExperience());
        txtStartDate2.setText(receptionist.getStartDate());
        txtPhone2.setText(receptionist.getPhone());
         
        
    }//GEN-LAST:event_btnSearch1ActionPerformed

    private void txtrecpno2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtrecpno2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtrecpno2ActionPerformed
    ...
    private void txtStartDate3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtStartDate3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtStartDate3ActionPerformed

    private void txtStartDate2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtStartDate2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtStartDate2ActionPerformed

    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        
        HMS_ReceptionistDetails recp = new HMS_ReceptionistDetails();
        
        String recpno = lblrecpno1.getText();
        ...
        String experience = txtExperience1.getText();
        ...
        String startdate = dateFormat.format(txtStartDate1.getDate());
        
        
        HMS_Receptionist id; 
              id =   new HMS_Receptionist(experience,startdate,recpno,firstname,secondname,nic,gender,age,birthday,mstatus, phone,address);
 
              
              
        recp.addReceptionist(id);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        String recpno = txtrecpno3.getText();
    ...
    private void txtNic1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNic1KeyPressed
        ...
        Validations_Recep val = new Validations_Recep();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HMS_ReceptionistGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HMS_ReceptionistGUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblrecpno1;
    ...
    public javax.swing.JTextField txtExperience1;
    public javax.swing.JTextField txtExperience2;
    public javax.swing.JTextField txtExperience3;
    ...
    public com.toedter.calendar.JDateChooser txtStartDate1;
    public javax.swing.JTextField txtStartDate2;
    public javax.swing.JTextField txtStartDate3;
    ...
    public javax.swing.JTextField txtrecpno2;
    public javax.swing.JTextField txtrecpno3;
